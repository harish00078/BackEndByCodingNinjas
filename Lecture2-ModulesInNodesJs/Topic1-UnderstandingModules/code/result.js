...
// V.V.IMP(NOTE) = when we (call) or (Import) our (module-functions) which we have created:they represent there selfs as (properties):because of the module.exports object:because we are exporting those functions through the object:
