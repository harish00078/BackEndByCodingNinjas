...
// V.V.IMP(NOTE) = here we can see that: when we are calling or importing our module-functions they are representing there selfs as (properties):because of the module.exports object:because we are exporting those functions with in the object:
