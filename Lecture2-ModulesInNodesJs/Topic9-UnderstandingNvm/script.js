console.log("Understanding Node Version Manager: (NVM)");
...
// 4. Use source $(brew --prefix nvm)/nvm.sh to configure nvm
// with the shell system.
// ● For Windows: You can download and run the installer from the NVM
