...
// (FS)-File System Module:It basically allows us to work with the file system on our computer:
...
// V.IMP-NOTE:Working with file-system is basically a (input-output) operation:because (fs) is also managed by the other system which is the operating system: so it is an input-output operation:because it has to interact with the operating system or we can say other system to perform the operations:
