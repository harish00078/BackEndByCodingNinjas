...
// IMP = here we are importing the (fs) module or library:it is a built-in module in nodejs:which known as (file-system) module:using this module we can access or work with files of our system:
const fs = require("fs");
