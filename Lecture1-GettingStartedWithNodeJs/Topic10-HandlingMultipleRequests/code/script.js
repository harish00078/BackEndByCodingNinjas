...
const server = http.createServer((req, res) => {
  // IMP = here the request-argument is basically a http-object or http-req-object:which basically have all the things related to request that has been send by the client to us:
